...
Begin VB.Form frmUpdateVendor 
   BorderStyle     =   1  'Fixed Single
   Caption         =   " « Update Vendor Masterdata"
   ClientHeight    =   6195
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7845
   ...
   Begin VB.CommandButton cmdExtract 
      Caption         =   "&Extract Downloaded Vendor Masterdata"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton cmdUpdate 
      Caption         =   "&Update Vendor Masterdata File"
      Enabled         =   0   'False
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "frmUpdateVendor"
...
'#           for SWIFT FOODS, INC.            #
'#                                            #
'#           area :  frmUpdateVendor          #
'#    description :  Code File                #
'#                :  Update Vendor Masterfile #
...
Private Sub cmdUpdate_Click()
   ...
   For i = 1 To Me.lv1.ListItems.Count
       ...
       rsVESVEN.FindFirst "Vendor = '" & Me.lv1.ListItems(i).SubItems(1) & "'"
       If Not rsVESVEN.NoMatch Then
          rsVESVEN.Edit
       Else
          rsVESVEN.AddNew
          rsVESVEN.Fields!Vendor = Mid(Me.lv1.ListItems(i).SubItems(1), 1, 7)
       End If
       rsVESVEN.Fields!Name = Mid(Me.lv1.ListItems(i).SubItems(2), 1, 30)
       rsVESVEN.Fields!Address1 = Mid(Me.lv1.ListItems(i).SubItems(3), 1, 30)
       rsVESVEN.Fields!Address2 = Mid(Me.lv1.ListItems(i).SubItems(4), 1, 30)
       rsVESVEN.Fields!Vatno = Mid(Me.lv1.ListItems(i).SubItems(5), 1, 15)
       rsVESVEN.Update
   Next
   Me.MousePointer = vbDefault
   MsgBox "Vendor masterdata file has been updated.", vbInformation, Me.Caption
   ...
   If Me.txtDestination.Text <> "" And Me.txtFileName.Text <> "" Then
      If UCase(Mid(Me.txtFileName.Text, Len(Me.txtFileName.Text) - 2, 3)) = "TXT" Then
         ...
         If FileExists(sFile) = False Then
            MsgBox "Downloaded vendor masterdata file does not exist.", vbInformation, Me.Caption
            Exit Sub
         End If
         Call ExtractVendor(sFile)
...
Public Sub ExtractVendor(varFile As String)
   Dim fnum As Integer
   Dim sTemp As String * 150
   
   Dim varTemp0 As String * 3    'Filler
   Dim varTemp1 As String * 7    'Vendor Number
   Dim varTemp2 As String * 35   'Vendor Name
   ...
   While Not EOF(fnum)
      ...
      varTemp0 = Mid(sTemp, 1, 3)
      varTemp1 = Mid(sTemp, 4, 7)
